...
| **C8** rank-deficiency probe: duplicated column, both solve routes raise `LinAlgError`, behaviours reported *(new: merged from Checkpoint 1.1)* | CP 1.1 | `test_rank_deficiency_probe` | independent |

7 MUST-MEET + 6 independent (miss-threshold ≤ 1).
