...
| **B6** grid posterior ≈ closed-form `Beta(a+y_N, b+N−y_N)` on a grid of r *(new: merged from Checkpoint 1.3)* | CP 1.3 | autograder | `test_grid_posterior_matches_closed_form` | independent |

5 MUST-MEET (A1, A2, A3, B3, D1) + 5 independent (B1, B2, B4, B5, B6); threshold ≤ 1.
